...
import fr.drn.soft.vehicle.manager.config.audit.AuditEventConverter;
import fr.drn.soft.vehicle.manager.domain.PersistentAuditEvent;
...
import static fr.drn.soft.vehicle.manager.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
