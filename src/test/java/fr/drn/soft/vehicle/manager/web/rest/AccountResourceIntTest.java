...
import fr.drn.soft.vehicle.manager.config.Constants;
import fr.drn.soft.vehicle.manager.VehicleManagerApp;
import fr.drn.soft.vehicle.manager.domain.Authority;
import fr.drn.soft.vehicle.manager.domain.User;
import fr.drn.soft.vehicle.manager.repository.AuthorityRepository;
import fr.drn.soft.vehicle.manager.repository.UserRepository;
import fr.drn.soft.vehicle.manager.security.AuthoritiesConstants;
import fr.drn.soft.vehicle.manager.service.MailService;
import fr.drn.soft.vehicle.manager.service.dto.UserDTO;
import fr.drn.soft.vehicle.manager.web.rest.errors.ExceptionTranslator;
import fr.drn.soft.vehicle.manager.web.rest.vm.KeyAndPasswordVM;
import fr.drn.soft.vehicle.manager.web.rest.vm.ManagedUserVM;
import fr.drn.soft.vehicle.manager.service.UserService;
