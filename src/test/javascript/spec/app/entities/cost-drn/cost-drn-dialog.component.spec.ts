...
import { CostDrnDialogComponent } from '../../../../../../main/webapp/app/entities/cost-drn/cost-drn-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('CostDrn Management Dialog Component', () => {
        let comp: CostDrnDialogComponent;
        let fixture: ComponentFixture<CostDrnDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CostDrnDialogComponent],
                providers: [
                    VehicleDrnService,
                    CostDrnService
                ]
            })
            .overrideTemplate(CostDrnDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(CostDrnDialogComponent);
